...
- **Profils d'une version antérieure** — un ancien lien rejoint un cercle tel quel : il compte partout où il a les réponses, et nulle part ailleurs (les dénominateurs du groupe s'ajustent seuls : « 1 sur 2 » au lieu de « 1 sur 3 »). Pour que ça ne passe pas pour un bug, le cercle l'écrit sous « le cercle en bref », la personne porte une étiquette (« sans les valeurs ») et son volet explique ce qui manque, avec un lien à lui envoyer pour compléter sans refaire le test. Son **prénom brille** et porte la mention « mise à jour disponible » : un clic dessus emmène directement aux seules affirmations qui manquent, et ramène au cercle avec le profil déjà échangé. **« Mettre à jour »** échange sinon son ancien lien contre le nouveau, à la même place et sous le même prénom — en une seule étape, donc une seule URL de cercle à repartager.
