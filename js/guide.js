...
(function () {
  ...
  section('amis', 'Entre amis', 'La comparaison et le cercle', `
    ...
    <ul class="glist">
      ...
      <li><b>Les clans</b> (à partir de quatre personnes) : un regroupement automatique fusionne les personnes les plus proches tant que deux groupes se ressemblent plus que la moyenne du cercle. Chaque clan reçoit un nom tiré de l'axe qui le distingue le plus des autres, avec ce qui le soude ; s'y ajoutent « le pont » (la personne la plus proche d'un autre clan que le sien) et la ligne de fracture entre les deux clans les plus éloignés.</li>
