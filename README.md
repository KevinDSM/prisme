...
- **Quel personnage serais-tu ?** — **32 univers et 588 personnages**, en cinq familles repliables : *jeux vidéo* (Zelda, World of Warcraft, Final Fantasy VII, League of Legends avec Arcane, Pokémon — uniquement les créatures, Clair Obscur : Expédition 33, Cyberpunk 2077 et Edgerunners), *cinéma* (Harry Potter, Le Seigneur des Anneaux, Star Wars, Marvel, Disney), *séries* (Game of Thrones, La Casa de Papel, Friends, Breaking Bad, The Office, Stranger Things, Kaamelott), *animation & manga* (JoJo, L'Attaque des Titans, One Piece, Naruto, Dragon Ball, Les Simpson, Moi quand je me réincarne en Slime, Solo Leveling, Death Note, Jujutsu Kaisen, Demon Slayer) et *le monde réel* (créateurs et créatrices, figures politiques de toutes époques — seul le tempérament public est comparé). Une quinzaine à trente personnages par univers, chacun avec son portrait, « pourquoi toi », « là où tu t'en écartes » et les deux suivants. Dans un cercle, un personnage différent pour chacun.
- **Quel animal, quel film, quelle musique ?** — trois listes plates traitées de la même façon : **73 animaux**, **76 films** et **56 morceaux**, décrits par leur tempérament et non par le goût qu'on en a. Chacune donne une carte (l'entrée, pourquoi elle, où l'on s'en écarte, les trois suivantes) et, dans un cercle, **une entrée différente par personne** : une ménagerie, une filmothèque et une playlist du groupe. Les listes sont dans `js/animals.js`, `js/films.js` et `js/musics.js`.
