...
(function () {
  ...
  section('liens', 'Les coulisses', 'Liens, versions et confidentialité', `
    <div class="gcards">
      ...
      <article class="gcard"><h4>Un cercle à versions mélangées</h4><p>Un ancien profil rejoint un cercle sans rien casser : il compte partout où il a les réponses, et nulle part ailleurs. Les moyennes du groupe s'ajustent d'elles-mêmes — une statistique de valeurs affichera « 1 sur 2 » là où les autres disent « 1 sur 3 ». Le cercle le dit en toutes lettres sous « le cercle en bref », et chaque personne concernée porte une étiquette (« sans les valeurs ») : ce n'est pas un bug, c'est une absence de données. Son <b>prénom brille</b> et porte la mention « mise à jour disponible » : en cliquant dessus, on part directement répondre aux seules affirmations qui manquent, et on revient au cercle à la fin avec le profil déjà échangé — il ne reste qu'à recopier la nouvelle URL. Si la personne a fait la mise à jour de son côté, <b>« Mettre à jour »</b> dans son volet échange son ancien lien contre le nouveau, à la même place et sous le même prénom.</p></article>
