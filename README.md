...
- **Quel personnage serais-tu ?** — dans chaque univers (The Legend of Zelda, World of Warcraft, JoJo's Bizarre Adventure, L'Attaque des Titans, La Casa de Papel), le personnage dont le profil psychologique ressemble le plus au tien, avec « pourquoi toi » et « là où tu t'en écartes ». Dans un cercle, un personnage différent pour chacun. Les licences sont dans `js/characters.js` : une licence = un objet de plus.
