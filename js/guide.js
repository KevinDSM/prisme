...
(function () {
  ...
  section('situations', 'Face au réel', 'Les quinze mises en situation', `
    ...
    <ul class="glist">
      <li><b>Ce que tu ferais, thème par thème.</b> Chaque réponse a <b>sa propre position</b>, notée sur les seuls thèmes où elle prend vraiment parti : « des droits de douane sur les produits délocalisés » est très souverainiste et un peu régulateur, mais ne dit rien de l'écologie. On ne prête jamais à une réponse la position moyenne de son camp sur un sujet dont elle ne parle pas. Ta position « en actes » sur un axe est la moyenne des positions des réponses choisies qui s'y prononcent. On la compare à ta position « en paroles », celle de tes curseurs : c'est le graphique « thème par thème ».</li>
      <li><b>Le score d'accord entre ce que tu dis et ce que tu ferais</b> : 100 moins l'écart moyen entre les deux, chaque prise de position pesant pareil — un thème touché par une seule réponse ne pèse pas autant qu'un thème touché par sept (il apparaît en pâle dans le graphique). Autour de 85 %, tes choix collent à tes curseurs ; en dessous de 60 %, ils racontent une autre histoire.</li>
      <li><b>La réponse que tes curseurs laissaient prévoir</b> : dans chaque situation, celle dont la position est la plus proche de tes curseurs sur les axes en jeu (à un souffle près, deux réponses presque aussi proches comptent toutes les deux). Le rapport compte combien de fois tu l'as choisie, et la montre quand ce n'est pas le cas.</li>
    ...
    <div class="gcards">
      ...
      <article class="gcard"><h4>Plus à gauche (ou à droite) en actes qu'en paroles</h4><p>Tes choix te placent à au moins dix points de ta place d'après tes curseurs, d'un côté ou de l'autre. Si tes curseurs te placent plus loin que la réponse la plus extrême proposée, on compare à cette réponse : choisir toujours la plus à droite, ce n'est pas être « plus à gauche en actes ». C'est très fréquent : devant un cas précis, on ne raisonne pas comme devant une affirmation générale.</p></article>
  ...
  section('disc', 'Le DISC', 'Le profil DISC en quatre couleurs', `
    ...
    <div class="gcards">
      ...
      <article class="gcard"><h4>MBTI, Big Five, Ennéagramme</h4><p>Trois modèles très connus, <b>estimés sans question en plus</b> en recombinant ce que le test mesure déjà. Le <b>Big Five</b> (ouverture, rigueur, extraversion, bienveillance, sensibilité émotionnelle) s'appuie sur les axes de caractère, le DISC, les valeurs, la morale et le module relations. Le <b>MBTI</b> en découle : E ou I suit l'extraversion, N ou S l'ouverture, T ou F la façon de décider (cœur ou tête) et la bienveillance, J ou P l'organisation et la rigueur ; une lettre « de peu » est à prendre avec des pincettes. L'<b>Ennéagramme</b> retient la motivation la plus forte parmi neuf (bien faire, aider, réussir, être soi, comprendre, être en sécurité, profiter, protéger, apaiser), et son « aile », le type voisin le plus présent. Les réponses réelles n'étant pas symétriques (on tient plus à ses racines ou à la sécurité que le hasard ne le voudrait), les scores sont recentrés sur des profils réels, pour que chaque type reste atteignable. Dans un cercle, une carte montre le type de chacun et ce qui domine dans le groupe. La carte MBTI s'explique d'elle-même : les <b>quatre questions</b> en clair, chacune avec ses deux réponses illustrées et une phrase sur toi ; <b>tes forces, ton quotidien et un point d'attention</b> ; et la <b>carte des 16 types</b> en quatre familles (Analystes, Inspirés, Ancrés, Spontanés), où ta case est mise en valeur. Dans un cercle, les initiales de chacun sont placées dans leur case. L'<b>Ennéagramme</b> se lit sur son étoile : neuf points, d'autant plus pleins que le type te ressemble, ta pointe entourée, ton aile en pointillés, et deux flèches vers le type où tu vas quand tout va bien et celui où tu glisses sous stress ; les trois centres (Instinct, Cœur, Tête) sont expliqués à côté. Le <b>Big Five</b> se lit sur un pentagone, puis trait par trait : une question en clair, une échelle entre deux pôles tous deux positifs, et un exemple du quotidien. Dans un cercle : l'étoile avec les initiales de chacun, et le pentagone moyen du groupe.</p></article>
  ...
  section('relations', 'Toi et les autres', 'Attachement, désaccords, façons d\'aimer', `
    ...
    <p class="gtext">À deux, les deux cartes portent vos deux points, avec ce que la rencontre de vos styles produit (le fameux duo « en demande » et « indépendant », deux défenseurs…) et ce qui fait plaisir à chacun. Dans un cercle : les <b>records</b> (le plus loyal, le plus en demande, le plus indépendant, le cœur sur la main, celui qui n'oublie pas…, décernés seulement à partir de 55), une <b>fiche par personne</b> (style d'attachement, façon de se disputer, rôle — différent pour chacun tant qu'il y en a — et six jauges : loyauté, besoin d'être rassuré, besoin d'espace, émotions montrées, pardon, famille), la carte des désaccords avec les initiales, le <b>climat du cercle</b> et ce qui fait plaisir à chacun. Les phrases de ce chapitre ne sont jamais citées mot pour mot dans le rapport.</p>`);
  ...
  section('personnages', 'Le sur-mesure', 'Quel personnage serais-tu ?', `
    <p class="gtext">Prisme connaît <b>${LICENSES.length} univers</b> et <b>${CAST_TOTAL} personnages</b>, rangés par famille (jeux vidéo, cinéma, séries, animation et manga, et le monde réel). La famille « le monde réel » contient des personnes réelles : seul leur tempérament public est comparé, jamais leur vie privée ou leur bilan — on peut être « Simone Veil » et penser tout autre chose qu'elle. Une seule exception : l'univers <b>Politiques français d'aujourd'hui</b> (les figures les plus influentes des huit grands partis, du Parti de la France à LFI). Là, les <b>positions publiques</b> de chacun sur les axes politiques comptent autant que son tempérament, parce que se retrouver « à côté » de quelqu'un qui défend l'inverse de ce qu'on pense n'aurait pas de sens. Les portraits décrivent le style et ce que chacun défend, sans jugement ni polémique, avec le même ton pour tous les partis. Dans chaque univers, tu es comparé à tout le casting : d'une quinzaine de personnages pour les plus petits à <b>l'intégralité des champions</b> pour League of Legends. Chaque personnage a son <b>profil psychologique</b>, écrit avec les mêmes dimensions que le test : qualités, couleurs DISC, valeurs, morale, traits et axes de caractère. Tes opinions politiques ne comptent pas : on peut être Link de gauche ou de droite.</p>
  ...
  const MORE = [
    ...
    ['Un organe', (window.PRISME_ORGANS || { ORGANS: [] }).ORGANS, 'le rôle dans le corps : celui qui ne s\'arrête jamais, celui qui filtre, celui qui décide, celui qu\'on oublie jusqu\'au jour où il manque'],
    ['Une émotion', (window.PRISME_EMOTIONS || { EMOTIONS: [] }).EMOTIONS, 'le caractère de l\'émotion : monter vite ou s\'installer, se montrer ou se cacher, pousser à agir ou à contempler'],
    ['Un emoji', (window.PRISME_EMOJIS || { EMOJIS: [] }).EMOJIS, 'l\'usage qu\'on en fait et le ton qu\'il donne à une conversation : l\'ironie douce, l\'enthousiasme, le malaise, la sagesse'],
    ['Une planète', (window.PRISME_PLANETS || { PLANETS: [] }).PLANETS, 'les huit planètes, leurs lunes, les planètes naines et quelques astres célèbres : brûlante ou glacée, rapide ou lente, proche du Soleil ou aventurière'],
    ['Une couleur', (window.PRISME_COLORS || { COLORS: [] }).COLORS, 'vive ou discrète, chaude ou froide, qui s\'impose ou qui accompagne'],
    ['Un objet du quotidien', (window.PRISME_OBJECTS || { OBJECTS: [] }).OBJECTS, 'celui qu\'on utilise sans y penser, celui qu\'on ne trouve jamais, celui qui dépanne tout le monde'],
    ['Une entreprise', (window.PRISME_BRANDS || { BRANDS: [] }).BRANDS, 'l\'image publique et la culture de l\'entreprise, sa façon de faire — jamais ses produits ni sa Bourse'],
    ['Un personnage de conte', (window.PRISME_TALES || { TALES: [] }).TALES, 'les contes de Perrault, des Grimm, d\'Andersen et des Mille et Une Nuits, d\'après les textes d\'origine : héros, seconds rôles et méchants'],
    ['Une ville française', (window.PRISME_CITIES || { CITIES: [] }).CITIES, 'le tempérament que la ville renvoie, raconté avec affection : son rythme, son caractère, ce qu\'on y aime'],
    ['Un vêtement', (window.PRISME_CLOTHES || { CLOTHES: [] }).CLOTHES, 'se voir ou se faire oublier, durer des années ou changer à chaque saison, protéger ou affirmer'],
    ['Un département français', (window.PRISME_DEPTS || { DEPARTMENTS_FR: [] }).DEPARTMENTS_FR, 'les 101 départements, outre-mer compris, racontés par leurs paysages, leurs produits et leurs traditions'],
    ['Une drogue (du quotidien)', (window.PRISME_DRUGS || { DRUGS: [] }).DRUGS, 'uniquement des petites addictions sans danger — café, chocolat, séries, sport, scroll infini… : ni stupéfiants, ni alcool, ni tabac'],
  ];
  section('etsi', 'Le sur-mesure', 'Et si tu étais…', `
    <p class="gtext">Dix-neuf listes de plus, calculées exactement comme les animaux ou les plats et rangées en accordéon en bas du rapport : on clique sur une liste pour découvrir la sienne, avec le pourcentage, le <b>pourquoi toi</b> et les trois suivantes. Rien ne dépend de tes goûts : c'est chaque fois le <b>tempérament</b> de l'entrée qui est comparé au tien. Les végétaux donnent en plus le meilleur de chaque famille (arbres, fleurs, plantes et herbes). Dans un cercle, chaque liste donne une entrée différente à chacun : la grille des programmes, le circuit touristique, le jardin, le tour du monde, le paquet de bonbons, l'hôpital, l'infirmerie, le corps, la palette d'émotions, la conversation, le système solaire, le nuancier, le tiroir, le conglomérat, le livre de contes, le tour de France, la garde-robe, la carte de France et les petites addictions du cercle.</p>
  ...
  section('resume', 'Le sur-mesure', 'Le résumé, les sujets de cœur, les curseurs cités', `
    <div class="gcards">
      <article class="gcard"><h4>Ton portrait</h4><p>Tout le test réuni en un seul texte, écrit comme on décrirait quelqu'un qu'on connaît bien : <b>au premier abord</b> (couleur DISC et traits de caractère les plus marqués), <b>ce qui compte</b> (valeurs et réflexes moraux), <b>les idées</b> (ce que tu défends, tes sujets de cœur, ta façon de tenir à tes convictions, et si tes actes suivent face au réel), <b>avec les autres</b> (attachement, disputes, rôle chez les tiens, façon d'aimer), <b>les forces</b>, <b>ce qui peut inquiéter</b> et <b>au fond</b>. Il cherche toujours le côté lumineux : une inquiétude y est décrite comme le revers d'une qualité. Dans un cercle, chacun a le sien, écrit avec son prénom, juste après « le cercle en bref » ; les phrases sont tournées pour ne jamais supposer le genre de personne. Le portrait continue en pratique : <b>En situation</b> (en soirée, au travail, en voyage, face à une crise), un <b>Mode d'emploi</b> (pour faire plaisir, quand ça ne va pas, après une dispute, ce qui donne de l'élan, à éviter) et deux <b>Pistes pour grandir</b>, toujours bienveillantes. Dans un cercle s'ajoutent <b>Dans ce cercle</b> (là où la personne se démarque nettement des autres, et ce qu'elle est seule à avoir) et <b>Le petit discours</b>, le toast que le cercle lui porterait. Tout en bas de chaque portrait, <b>Ce qui matche avec…</b> aligne une pastille par personne du cercle, de la plus proche à la plus lointaine : un toucher affiche un petit texte sur ce qui vous rapproche, en politique (positions défendues ensemble, même famille, sujets de cœur), dans la tête (tempérament, couleur DISC, valeurs, réflexe moral, forces) et avec les autres (façon de gérer un désaccord, d'aimer, place de la famille).</p></article>
      <article class="gcard"><h4>Le détail en cinq temps</h4><p>Il est écrit à partir de tes scores, et d'eux seuls : <b>ce que tu penses</b> (tes axes politiques les plus marqués, ta famille la plus proche et la plus lointaine), <b>comment tu le penses</b> (tempérament et axes méta), <b>comment tu fonctionnes</b> (archétype, personnalité, DISC), <b>ce qui te fait vibrer</b> (fondements et traits) et <b>ce qui te distingue</b> (tes positions les plus nettes, ton style de réponse, ta cohérence). Deux personnes n'ont jamais le même texte.</p></article>
  ...
  section('amis', 'Entre amis', 'La comparaison et le cercle', `
    ...
    <ul class="glist">
      ...
      <li><b>Étincelles et accords</b> : pour chaque paire du cercle, Prisme calcule un score de dispute (écart d'idées, sujets opposés — surtout ceux marqués d'un cœur —, deux tempéraments qui aiment la confrontation et doutent peu, valeurs qui tirent en sens inverse, façons de se disputer qui se heurtent) et un score d'entente (affinité, sujets où les deux sont nettement du même côté, même valeur en tête, et l'un qui donne naturellement ce qui touche l'autre). Les duos les plus nets s'affichent avec une phrase, les sujets précis et la position de chacun ; une même personne n'apparaît pas plus de deux fois par liste.</li>
