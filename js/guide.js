...
(function () {
  ...
  section('amis', 'Entre amis', 'La comparaison et le cercle', `
    ...
    <ul class="glist">
      ...
      <li><b>Créer mon image</b> : une image au format story (1080 × 1920), prête à poster. Elle montre ton prénom, <b>ton spectre</b> — un prisme qui décompose la lumière en quatre bandes aux couleurs DISC, chacune aussi épaisse que ton score —, ta famille, ton tempérament, ton archétype, puis ton personnage (le plus proche, tous univers confondus), ton animal, ton plat et ton poste. L'image est <b>fabriquée sur ton appareil</b> : aucune donnée ne part vers un serveur. On la télécharge, ou on la passe directement au partage du téléphone quand il le permet.</li>
