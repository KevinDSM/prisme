...
- **Quel personnage serais-tu ?** — **28 univers et 331 personnages**, rangés en cinq familles : *jeux vidéo* (Zelda, World of Warcraft, Final Fantasy VII, League of Legends, Pokémon), *cinéma* (Harry Potter, Le Seigneur des Anneaux, Star Wars, Marvel, Disney), *séries* (Game of Thrones, La Casa de Papel, Friends, Breaking Bad, The Office, Stranger Things, Kaamelott), *animation & manga* (JoJo's Bizarre Adventure, L'Attaque des Titans, One Piece, Naruto, Dragon Ball, Les Simpson, Moi quand je me réincarne en Slime, Solo Leveling, Death Note) et *le monde réel* (créateurs et créatrices, figures politiques de toutes époques — seul le tempérament public est comparé, jamais les idées ni le bilan). Chaque famille est un volet replié : on n'ouvre que ce qui intéresse. Dans chaque univers, le personnage dont le profil psychologique ressemble le plus au tien : portrait détaillé, « pourquoi toi », « là où tu t'en écartes » et les deux suivants du classement. Dans un cercle, un personnage différent pour chacun. Les licences sont dans `js/characters.js` : une licence = un objet de plus (avec `group`, `kind`, `color` et au moins 8 personnages).
- **Quel animal serais-tu ?** — la même comparaison, sur **73 animaux** décrits avec les dimensions du test. Ton animal, pourquoi lui, où tu t'en écartes, et les trois suivants. Dans un cercle, **un animal différent par personne** : à onze, personne ne tombe sur le même. Les animaux sont dans `js/animals.js`.
