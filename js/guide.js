...
(function () {
  ...
  section('liens', 'Les coulisses', 'Liens, versions et confidentialité', `
    <div class="gcards">
      ...
      <article class="gcard"><h4>Un cercle à versions mélangées</h4><p>Un ancien profil rejoint un cercle sans rien casser : il compte partout où il a les réponses, et nulle part ailleurs. Les moyennes du groupe s'ajustent d'elles-mêmes — une statistique de valeurs affichera « 1 sur 2 » là où les autres disent « 1 sur 3 ». Le cercle le dit en toutes lettres sous « le cercle en bref », et chaque personne concernée porte une étiquette (« sans les valeurs ») : ce n'est pas un bug, c'est une absence de données. Quand la personne a complété son profil, <b>« Mettre à jour »</b> dans son volet échange son ancien lien contre le nouveau, à la même place et sous le même prénom.</p></article>
