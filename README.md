...
- **Une page pliée** — le rapport complet fait plusieurs mètres, ce qui décourage avant d'avoir commencé. Chaque bloc est donc un **volet** : la page de résultats et la page de cercle arrivent repliées et se lisent d'abord comme un sommaire de titres qu'on ouvre d'un clic. Restent ouverts au départ : les trois portraits (la famille politique seule sur téléphone) et « le cercle en bref ». Un bouton **Tout déplier / Tout replier**, et le sommaire latéral ouvre le volet qu'il vise.
